...
<table border='1'>
    ...
    while ($res = mysqli_fetch_row($sql)) {
        ...
        <tr>
            ...
            <td><a href='./departments/update.php?id=<?= (integer)$res[0] ?>?action=update'>UPDATE</a>
            <td><a href='./departments/delete.php?id=<?= (integer)$res[0] ?>?action=delete'>DELETE</a>
        </tr>
    <?php } ?>
</table>


<a class='action' href='./departments/create.php?action=create'>Создать</a>
